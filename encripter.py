...
def main_screen():
    ...
    Label(text="enter the encryption and decription",
          fg="black", font=("roboto", 13)).place(x=10, y=10)
    text1 = Text(font="Rpbote 20", bg="white", relief=GROOVE, wrap=WORD, bd=0)
    text1.place(x=10, y=50, width=355, height=100)

    Label(text="enter key for en and de",   fg="black",
          font=("roboto", 13)).place(x=10, y=170)
